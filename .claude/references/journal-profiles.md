...
**Focus:** Empirical management research -- organizational behavior, strategy, HR, entrepreneurship, international business. The most empirically rigorous management journal.
**Bar:** Strong empirical contribution grounded in management theory. AMJ values theory-testing with rigorous methods. Formal hypotheses expected.
**Typical paper length:** 12,000-15,000 words. Management papers run long -- extensive theory, hypotheses, methods, and discussion sections expected.
**Review timeline:** 2-4 months for first decision. Typically 2-3 rounds. AMJ R&Rs can involve substantial rewriting.
**What editors look for:** Well-developed theory section with clearly derived hypotheses (H1, H2, ...). Empirical test that maps cleanly onto the hypotheses. Novel data or empirical context. Contribution to management theory, not just empirical regularity.
**What gets desk rejected:** No formal hypotheses. Theory disconnected from empirics. Pure economics paper without management theory. Qualitative work (send to AMJ Discoveries or ASQ instead).
**Domain referee adjusts:** Theory-hypotheses-data structure is non-negotiable. Each hypothesis must follow logically from the theoretical argument. Multiple levels of analysis (individual, team, firm) common. Moderation and mediation hypotheses expected. Management-specific constructs (absorptive capacity, dynamic capabilities, social capital, institutional logics) must be properly measured and cited.
**Methods referee adjusts:** Endogeneity concerns front and center -- firm strategy, organizational structure, and HR practices are endogenous. IV, DiD, matching, and selection models expected for causal claims. Multilevel models for nested data (individuals in firms). Interaction effects must be properly interpreted (marginal effects, not just coefficients). Robustness to alternative specifications and measures.
**Typical concerns:** "Is strategy/structure endogenous?" "What about reverse causality?" "How do you measure [construct]?" "Are the hypotheses clearly derived from theory?" "What about alternative theoretical explanations?"
**Referee pool:** THEORY (high), CREDIBILITY (high), MEASUREMENT (high), STRUCTURAL (medium), SKEPTIC (medium), POLICY (low)
...
**Focus:** General sociology -- the discipline's flagship. Publishes across all subfields: stratification, organizations, culture, political sociology, demography, economic sociology, race/ethnicity, gender.
**Bar:** Must advance sociological theory with rigorous evidence. The question should matter to sociologists broadly, not just one subfield. ASR papers redefine how sociologists think about a phenomenon.
**Typical paper length:** 10,000-12,000 words (excluding references, tables, figures). No strict word limit but editors expect concise writing.
**Review timeline:** 2-4 months for first decision. Typically 2 rounds (R&R then conditional accept). Desk rejection rate ~60-70%.
**What editors look for:** A clear theoretical contribution that changes or extends how sociologists understand a social process. Empirical rigor commensurate with the causal claims made. Broad appeal across subfields.
**What gets desk rejected:** Narrow empirical finding without theoretical payoff. Pure methods papers. Papers that read as economics papers with sociological data. Insufficient engagement with sociological theory.
**Domain referee adjusts:** Theoretical framing must be sociological -- not just "applied economics with sociological variables." Background section builds an argument, not a literature review. The paper must speak to at least one major sociological debate. Mechanisms should invoke social processes (institutions, networks, culture, power), not just individual optimization.
**Methods referee adjusts:** Identification expectations have risen sharply since ~2015 but remain below economics journals. Fixed effects, DiD, and IV accepted; RDD and event studies increasingly common. Descriptive work still publishable if the question is important and the measurement is novel. Decomposition methods valued for inequality papers. Sensitivity analysis (Oster bounds) increasingly expected.
**Typical concerns:** "What is the sociological contribution?" "How does this advance theory beyond [prior work]?" "Is this just applied economics?" "What social process generates this pattern?" "Does this speak to sociologists outside your subfield?"
**Referee pool:** THEORY (high), CREDIBILITY (high), MEASUREMENT (medium), STRUCTURAL (medium), POLICY (low), SKEPTIC (low)

### American Journal of Sociology (AJS)
**Focus:** General sociology -- the discipline's other flagship, housed at University of Chicago. Historically more receptive to cultural sociology, historical sociology, and theory-heavy papers than ASR.
**Bar:** Deep theoretical insight with rigorous evidence. AJS prizes intellectual ambition and papers that open new lines of inquiry. Slightly more tolerance for unconventional approaches than ASR.
**Typical paper length:** 10,000-14,000 words. AJS papers tend to run longer than ASR papers -- more room for theoretical development and historical/institutional context.
**Review timeline:** 3-5 months for first decision (historically slower than ASR). Typically 2-3 rounds. Desk rejection rate ~60%.
**What editors look for:** Intellectual ambition. Papers that define a new concept, reveal a previously unseen social process, or fundamentally reframe an empirical domain. Theoretical originality valued over methodological sophistication.
**What gets desk rejected:** Incremental empirical findings. Papers without a clear theoretical payoff. Pure replication or extension of existing work.
**Domain referee adjusts:** Theoretical ambition paramount. AJS referees expect the paper to grapple with "big" questions even if the empirical setting is specific. Historical and institutional context expected. The paper should feel like it *teaches* the reader something about how society works. Cultural and qualitative evidence valued alongside quantitative.
**Methods referee adjusts:** Methodological expectations below ASR for causal identification -- AJS values theoretical insight over clean identification. Descriptive and historical-comparative work fully accepted. For quantitative papers, standard applied micro methods expected but not the bleeding-edge DiD estimators. Ethnographic and interview-based papers welcome with systematic methods.
**Typical concerns:** "What is the big idea here?" "How does this change how we think about [social process]?" "Is the theoretical framework doing work, or is it window dressing?" "What does this tell us about society that we didn't know?"
**Referee pool:** THEORY (high), STRUCTURAL (high), MEASUREMENT (medium), CREDIBILITY (medium), SKEPTIC (low), POLICY (low)

### Social Forces
**Focus:** Broad sociology journal with strength in stratification, demography, economic sociology, political sociology, and race/ethnicity. More empirically oriented than ASR/AJS.
**Bar:** Solid empirical contribution with clear connection to sociological questions. Below ASR/AJS bar for theoretical novelty but same or higher expectations for empirical rigor. Good outlet for well-executed applied work.
**Typical paper length:** 8,000-10,000 words.
**Review timeline:** 2-4 months for first decision. Typically 2 rounds. Desk rejection rate ~50%.
**What editors look for:** Careful empirical work that speaks to an important sociological question. Clear research design. Replication and extension of important findings valued. International and comparative work welcome.
**What gets desk rejected:** Pure description without theoretical framing. Papers that don't engage sociological literature. Overly narrow empirical scope.
**Domain referee adjusts:** Empirical rigor is the strength here -- referees expect careful measurement, appropriate methods, and thorough robustness. Theoretical framing should be clear but doesn't need to be groundbreaking. Inequality, mobility, and demographic processes are home turf. Policy relevance appreciated but not required.
**Methods referee adjusts:** Quantitative methods dominant. Fixed effects, DiD, decomposition methods all standard. Modern causal inference methods valued. Large-N survey analysis common. Multilevel models for nested data. Careful treatment of selection and endogeneity expected.
**Typical concerns:** "Is the empirical strategy convincing?" "Have you checked robustness?" "How does this extend [specific prior paper]?" "What are the implications for inequality/stratification?"
**Referee pool:** CREDIBILITY (high), MEASUREMENT (high), THEORY (medium), SKEPTIC (medium), STRUCTURAL (low), POLICY (low)

### Sociological Science
**Focus:** Open-access general sociology journal. Emphasizes rapid review and publication of well-executed sociological research. All subfields welcome.
**Bar:** Solid sociological contribution with rigorous evidence. Values clarity and efficiency -- no bloated papers. The contribution should be clear by page 3.
**Typical paper length:** 4,000-8,000 words. Explicitly values concision. Shorter than ASR/AJS by design.
**Review timeline:** 30-day review target. Typically 1 round (accept, reject, or minor revisions). Very fast by sociology standards.
**What editors look for:** Clear contribution, clean execution, efficient writing. Papers where the finding speaks for itself without 20 pages of theoretical scaffolding. Replication, null results, and negative findings accepted if the question matters.
**What gets desk rejected:** Overwritten papers that could be half as long. Papers where the theoretical framework obscures rather than clarifies. Methodologically unsound work.
**Domain referee adjusts:** Clarity and concision valued. The theoretical contribution should be stated plainly -- no need for elaborate theoretical architecture. Empirical novelty (new data, new measurement, new setting) valued as much as theoretical novelty. Replication of important findings is a valid contribution.
**Methods referee adjusts:** Same rigor expectations as top journals. Modern methods expected. Pre-registration viewed favorably. Transparency and replicability emphasized. Supplementary materials can hold additional robustness checks.
**Typical concerns:** "Can this be said more concisely?" "Is the contribution clear?" "Does the evidence support the claim?" "Would this survive replication?"
**Referee pool:** CREDIBILITY (high), MEASUREMENT (high), SKEPTIC (medium), THEORY (medium), STRUCTURAL (low), POLICY (low)

### Demography
**Focus:** Population science -- fertility, mortality, migration, family, aging, health disparities, spatial demography. Interdisciplinary: sociology, economics, public health, geography.
**Bar:** Rigorous demographic research with clear population-level implications. Values careful measurement and large representative samples. Both descriptive and causal work valued.
**Typical paper length:** 8,000-10,000 words.
**Review timeline:** 2-4 months for first decision. Typically 2 rounds. Desk rejection rate ~50%.
**What editors look for:** Important population question with appropriate data and methods. Demographic techniques (life tables, decomposition, hazard models) expected when applicable. Representative samples or careful discussion of selection. International comparative work valued.
**What gets desk rejected:** Non-demographic question using demographic data. Papers without population-level implications. Inadequate data for the population claims made.
**Domain referee adjusts:** Population thinking required -- rates, composition, decomposition. Must understand difference between period and cohort effects. Age-period-cohort decomposition when relevant. Health disparities by race, SES, geography central to the journal. Family demography (marriage, divorce, fertility, household structure). Immigration and immigrant integration.
**Methods referee adjusts:** Hazard models (Cox, discrete-time, competing risks) standard for event-history analysis. Decomposition methods (Kitagawa, DFL, DiNardo-Fortin-Lemieux) for trend analysis. Multilevel models for spatial variation. Modern causal inference valued but descriptive demography also welcome. Survey weights and complex sample design must be handled correctly.
**Typical concerns:** "Is this a period or cohort effect?" "What about compositional change?" "Is your sample representative of the population you're studying?" "Have you decomposed the trend?" "What are the implications for population health/structure?"
**Referee pool:** MEASUREMENT (high), CREDIBILITY (high), STRUCTURAL (medium), THEORY (medium), POLICY (medium), SKEPTIC (low)

### Work and Occupations
**Focus:** Sociology of work, labor markets, occupations, professions, employment relations, workplace inequality
**Bar:** Solid contribution to understanding work and labor markets from a sociological perspective. Values both quantitative and qualitative research. More specialized than ASR/AJS but deep expertise in work/labor.
**Typical paper length:** 8,000-10,000 words.
**Review timeline:** 2-4 months for first decision. Typically 2 rounds.
**What editors look for:** Papers that illuminate how work is organized, experienced, and rewarded. Workplace inequality by race, gender, and class. Occupational change and the future of work. Employment relations and labor market institutions. Qualitative case studies of workplaces welcome.
**What gets desk rejected:** Papers about labor markets that don't engage sociological theory of work. Pure economics papers about wages without organizational or institutional content.
**Domain referee adjusts:** Organizational and institutional context of work must be front and center. How do firms, occupations, and labor market institutions shape outcomes? Relational inequality theory, job quality, precarious work, gig economy. Gender and racial inequality in the workplace. Union effects beyond wages (dignity, voice, governance).
**Methods referee adjusts:** Quantitative papers: standard applied micro plus organizational data (matched employer-employee, establishment surveys). Qualitative papers: ethnography, interviews, case studies with systematic methods. Mixed methods valued. Administrative data on firms and workers increasingly expected.
**Typical concerns:** "What does the organizational context contribute?" "How do institutions shape this outcome?" "Is this about work specifically, or just labor markets generally?" "What does this tell us about inequality at work?"
**Referee pool:** THEORY (high), MEASUREMENT (high), CREDIBILITY (medium), STRUCTURAL (medium), POLICY (low), SKEPTIC (low)

### Sloan Management Review (SMR)
**Focus:** Evidence-based management practice -- bridges academic research and managerial practice. Published by MIT Sloan.
**Bar:** Accessible synthesis of rigorous research with clear implications for managers. Not a traditional academic journal -- no peer review in the standard sense. Values clarity, relevance, and actionable insights.
**Typical paper length:** 3,000-5,000 words. Short, accessible, practitioner-oriented.
**Review timeline:** 1-3 months. Editor-driven process rather than traditional peer review.
**What editors look for:** Research-backed insights that managers can act on. Clear writing without jargon. Surprising or counterintuitive findings. Visual frameworks and typologies that practitioners can apply.
**What gets desk rejected:** Academic papers in disguise. Papers heavy on methodology and light on implications. Purely theoretical work without practical applications.
**Domain referee adjusts:** Write for a smart MBA, not for an academic reviewer. Lead with the managerial insight, not the literature gap. Evidence must be rigorous but the presentation must be accessible. Case examples and illustrations expected. Frameworks and typologies valued.
**Methods referee adjusts:** Methods should be described briefly and clearly -- readers trust the rigor but don't want to read the appendix. Focus on effect sizes and practical significance, not p-values. Data visualization for key findings.
**Typical concerns:** "What should a manager do differently after reading this?" "Can you explain this without jargon?" "Is the evidence base strong enough to advise practitioners?" "Can you give a real-world example?"
**Referee pool:** POLICY (high), STRUCTURAL (medium), THEORY (medium), CREDIBILITY (medium), MEASUREMENT (low), SKEPTIC (low)
